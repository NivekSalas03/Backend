        ...
        <div class="col-sm-2"></div>
          <div class="col-sm-8">
            ...
            <div class="card " style="background-color:#a2ded0; border:solid #000;">
                <div class="card-header"> MODIFICAR PRODUCTO NUEVO <i class="fa fa-user-plus text-warning float:right"></i>
                ...
                <div class="card-body">
                    ...
                    <form action="<?php echo RUTA_URL;?>/productos/editar/<?php echo $datos['IdProducto']?>" method="post" enctype="multipart/form-data">
                    <div class="row">                        
                        <div class="col-sm-8">
                    ...
                    <div class="row">
                        <div class="col-sm-2"></div>
                        <div class="col-sm-4">
                            <button type="submit" class="btn btn-success btn-block"> Modificar <i class="fa fa-save"></i> </button>
                        </div>
                        <div class="col-sm-2"></div>
                    </div>
